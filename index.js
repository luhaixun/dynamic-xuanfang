 ...
 *
 * 命令行用法：
 *   node index.js --target 318.64 --topK 10 --A ./data/qifang.txt --B ./data/xianfang.txt [--source AB]
 ...
 *   // const results = solveTopK(318.64, { topK: 10, source: "AB", fileAPath: "./data/qifang.txt", fileBPath: "./data/xianfang.txt" });
 */
